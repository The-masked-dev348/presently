...
export default function PublicPortfolio() {
  ...
  const preview: PreviewPortfolio = { fullName: portfolio.fullName || query.data.owner.name || "", professionalTitle: portfolio.professionalTitle || "", bio: portfolio.bio || "", location: portfolio.location || "", skills: portfolio.skills || "", templateId: portfolio.templateId as PreviewPortfolio["templateId"], socialLinks: parseSocialLinks(portfolio.socialLinks), profileImageUrl: query.data.profileImageUrl ?? null, projects: projects.map(project => ({ id: project.id, title: project.title, description: project.description, technologies: project.technologies, liveUrl: project.liveUrl, githubUrl: project.githubUrl, media: project.media })) };
